...
public class UIGlobalData : MonoSingleton<UIGlobalData>
{
    ...
    public static void RemoveUIComponent(UIComponent _component) { Instance._removeUiComponent(_component); }
    ...
    void _removeUiComponent(UIComponent _component) 
    {
        if (_component == null || uIComponents == null) return;
        uIComponents.Remove(_component);
    }
